...
class UtilisateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $utilisateurs = $em->getRepository('AppliFraisBundle:Utilisateur')->findAll();

        return $this->render('@AppliFrais/utilisateur/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppliFraisBundle\Form\UtilisateurType', $utilisateur);
        ...
        return $this->render('@AppliFrais/utilisateur/new.html.twig', array(
    ...
    public function showAction(Utilisateur $utilisateur)
    {
        ...
        return $this->render('@AppliFrais/utilisateur/show.html.twig', array(
            'utilisateur' => $utilisateur,
    ...
    {
        $deleteForm = $this->createDeleteForm($utilisateur);
        $editForm = $this->createForm('AppliFraisBundle\Form\UtilisateurEditType', $utilisateur);
        ...
        return $this->render('@AppliFrais/utilisateur/edit.html.twig', array(
            'utilisateur' => $utilisateur,
